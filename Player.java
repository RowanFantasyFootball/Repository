...
public class Player{
    ...
    private Clock clock; //Team IR added Clock object instance variable/
    private Player player; //Team IR added Player object instance variable/
    private PlayerStat stat; //Team IR added PlayerStat object instance variable/
     ...
     */
    public Player(NFLTeam team, Clock c, Randomizer random, String[] s)
    {
        positionWithBall = "";
        this.clock = clock;
        this.team = team;
    ...
    {
        msg.getPlayerPosition();
    }
    public void getOverall()
    {
        msg.getPlayerOverall();
    }
    public void getPlayerSpeed()
    {
        msg.getPlayerSpeed();
    }
    public void getPlayerStrength()
    {
        msg.getPlayerStrength();
    }
