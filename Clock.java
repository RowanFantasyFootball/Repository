...
public class Clock {
	...
	/**
	 * Changes the quarter by incrementing and setting nextQuarter. Also, may
	 * change the quarter length.
	 * 
	 * nextQuarter is when the next quater is over
	 */
	 ...
	 * 
	 * @return ticks the current amount of game ticks that have went by in the
	 *         game.
	 */
	public int getTicks() {
		return ticks;
	 ...
	 *
	 * Uses a switch statement to switch through all possible values of a
	 * quarter. (1-4), then returns the String equivalent.
	 *
