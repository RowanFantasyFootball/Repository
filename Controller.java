...
{                   
    ...
    private Team team1;  // Eagles
    private Team team2;  // Cowboys
    /**
    ...
    public Controller()
    {
        ...
        actors.add(stats);
        actors.add(team1.getPlayers());
        actors.add(team2.getPlayers());
        actors.add(team1); //team
        actors.add(team2); //team
    ...
    {        
        ...
        for (NFLPlayer p : team1.getOffense()) {
            System.out.println(p + " - " + p.getPosition() + "\n\tOverall: " + p.getOverall() + "\n\tSpeed: " + p.getSpeed() + "\n\tStrength: " + p.getStrength());
        }
        System.out.println("\nDefense:\n");
        for (NFLPlayer p : team1.getDefense()) {
            System.out.println(p + " - " + p.getPosition() + "\n\tOverall: " + p.getOverall() + "\n\tSpeed: " + p.getSpeed() + "\n\tStrength: " + p.getStrength());
        }
        ...
        for (NFLPlayer p : team2.getOffense()) {
            System.out.println(p + " - " + p.getPosition() + "\n\tOverall: " + p.getOverall() + "\n\tSpeed: " + p.getSpeed() + "\n\tStrength: " + p.getStrength());
        }
        System.out.println("\nDefense:\n");
        for (NFLPlayer p : team2.getDefense()) {
            System.out.println(p + " - " + p.getPosition() + "\n\tOverall: " + p.getOverall() + "\n\tSpeed: " + p.getSpeed() + "\n\tStrength: " + p.getStrength());
        }
    }
